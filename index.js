...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var calculator, operation, expression, result, _a, firstNumber, secondNumber, num1, num2, result;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    calculator = new types_1.Calculator();
                ...
                case 1:
                    ...
                    if (!(operation === 'Evaluate Expression')) return [3 /*break*/, 3];
                    return [4 /*yield*/, inquirer_1.default.prompt([
                            {
                                type: 'input',
                                name: 'expression',
                ...
                case 4:
                    _a = _b.sent(), firstNumber = _a.firstNumber, secondNumber = _a.secondNumber;
